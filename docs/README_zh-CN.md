...
| 仪表盘 | 营销任务 |
| :---: | :---: |
| ![仪表盘](image/zh/02.png) | ![营销任务](image/zh/06.png) |

| 联系人 | 邮件模板 |
| :---: | :---: |
| ![联系人](image/zh/05.png) | ![模板](image/zh/10.png) |

| 发送通道 | 域名管理 |
| :---: | :---: |
| ![发送通道](image/zh/04.png) | ![域名管理](image/zh/08.png) |

| 收件箱 | 密钥管理 |
| :---: | :---: |
| ![收件箱](image/zh/07.png) | ![密钥管理](image/zh/09.png) |

| 发送日志 | 登录页面 |
| :---: | :---: |
| ![发送日志](image/zh/11.png) | ![登录页面](image/zh/01.png) |

| 文件管理 | 系统设置 |
| :---: | :---: |
| ![文件管理](image/zh/12.png) | ![系统设置](image/zh/15.png) |
